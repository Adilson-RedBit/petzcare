...
import { Heart, Weight, Calendar, FileText, User, Phone, Mail, MapPin } from 'lucide-react';
...
export default function PetForm({ onSubmit, onCancel, hideOwner }: PetFormProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl border border-purple-200">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {/* Owner Information Section — hidden when data already collected upstream */}
        {!hideOwner && (
